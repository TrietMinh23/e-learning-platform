...
CREATE TABLE
  QuizQAAnswerDetail (
    ...
    CONSTRAINT PK_QuizQAAnswerDetail PRIMARY KEY (
      answer,
      quiz_qa_id,
      quiz_id,
      section_id,
...
ALTER TABLE QuizQA ADD CONSTRAINT FK_QuizQA_QuizQAAnswerDetail FOREIGN KEY (correct_answer) REFERENCES QuizQAAnswerDetail (answer);
...
CREATE TABLE
  StudentAnswerQA (
    ...
    answer VARCHAR(600) NOT NULL,
    learner_id MEDIUMINT UNSIGNED NOT NULL,
    CONSTRAINT PK_StudentAnswerQA PRIMARY KEY (
      quiz_id,
      quiz_qa_id,
      section_id,
      course_id,
    ...
    CONSTRAINT FK_StudentAnswerQA_QuizQAAnswerDetail FOREIGN KEY (
      answer,
      quiz_qa_id,
      quiz_id,
      section_id,
      course_id
    ) REFERENCES QuizQAAnswerDetail (
      answer,
      quiz_qa_id,
      quiz_id,
      section_id,
